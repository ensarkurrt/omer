  ...
  <div class="q-pa-md" style="max-width: 500px; margin-left: 200px;">
   ...
   <q-tab-panel name="Giriş">
     ...
     >
       ...
       <div>
         <q-btn style="width: 200px; height: 60px; " label="Giriş" type="Giriş" color="red"></q-btn>
       </div>
     </q-form>
   ...
   <q-card-section class="text-left q-mx-xs q-my-xs q-px-xs q-py-xs">
    ...
    <a href="#" style="color:black;" class="text-black-0">Hesabınız yok mu? Şimdi bir tane oluşturun</a>
     ...
     <q-tab-panel name="Kayıt Ol">
       <q-input color=dark v-model="text3" label="Adınız"></q-input>
       <q-input color=dark v-model="text4" label="Soyadınız"></q-input>
       <q-input color=dark v-model="text5" label="E-Mail"></q-input>
       <q-input color=dark v-model="text6" label="Cep Telefonu"></q-input>
       <q-input
          color=black
          v-model="password"
          label="*Parola"
       ...
       <div>
         <q-btn style="width: 200px; height: 50px; " label="Hesap Oluştur" type="Hesap Oluştur" color="red"></q-btn>
       </div>
       </div>
       </q-tab-panel>
  ...
  return {
    ...
    onSubmit () {
         /*  if (accept.value !== true) {
            ...
            // TODO :: LOGIN ICIN
            auth.signInWithEmailAndPassword(this.text1,this. password)
            .then((user) => {
              console.log(user)
            })
            .catch((error) => {
            ...
            // TODO :: SIGNUP ICIN
           /*  auth.createUserWithEmailAndPassword(this.text5, this.password)
            .then((user) => {
              console.log(user)
            })
            .catch((error) => {
